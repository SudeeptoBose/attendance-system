...
SELECT UserID, UserName, Password FROM Users WHERE (UserID = @UserID)";
        ...
        public virtual int FillByUsernameAndPassword(DataSet1.UsersDataTable dataTable, string UserName, string Password) {
        ...
        public virtual DataSet1.UsersDataTable GetDataByUsernameAndPassword(string UserName, string Password) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((UserName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
...
SELECT ClassID, ClassName, UserID FROM Classes WHERE (ClassID = @ClassID)";
        ...
        public virtual int AddClassQuery(string ClassName, global::System.Nullable<int> UserID) {
